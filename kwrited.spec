...
Version  : 5.27.1
Release  : 78
URL      : https://download.kde.org/stable/plasma/5.27.1/kwrited-5.27.1.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.27.1/kwrited-5.27.1.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.1/kwrited-5.27.1.tar.xz.sig
...
%prep
%setup -q -n kwrited-5.27.1
cd %{_builddir}/kwrited-5.27.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677182628
mkdir -p clr-build
pushd clr-build
