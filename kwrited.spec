...
Version  : 6.1.0
Release  : 99
URL      : https://download.kde.org/stable/plasma/6.1.0/kwrited-6.1.0.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.1.0/kwrited-6.1.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.0/kwrited-6.1.0.tar.xz.sig
...
%setup -q -n kwrited-6.1.0
cd %{_builddir}/kwrited-6.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718817339
mkdir -p clr-build
pushd clr-build
