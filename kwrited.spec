...
Version  : 5.26.5
Release  : 75
URL      : https://download.kde.org/stable/plasma/5.26.5/kwrited-5.26.5.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.26.5/kwrited-5.26.5.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.26.5/kwrited-5.26.5.tar.xz.sig
...
%prep
%setup -q -n kwrited-5.26.5
cd %{_builddir}/kwrited-5.26.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673283511
mkdir -p clr-build
pushd clr-build
