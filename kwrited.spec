...
Version  : 5.14.4
Release  : 8
URL      : https://download.kde.org/stable/plasma/5.14.4/kwrited-5.14.4.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.14.4/kwrited-5.14.4.tar.xz
Source99 : https://download.kde.org/stable/plasma/5.14.4/kwrited-5.14.4.tar.xz.sig
...
export LANG=C
export SOURCE_DATE_EPOCH=1543394425
mkdir -p clr-build
pushd clr-build
%cmake ..
