...
Version  : 5.27.7
Release  : 85
URL      : https://download.kde.org/stable/plasma/5.27.7/kwrited-5.27.7.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.27.7/kwrited-5.27.7.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.7/kwrited-5.27.7.tar.xz.sig
...
%prep
%setup -q -n kwrited-5.27.7
cd %{_builddir}/kwrited-5.27.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1690895381
mkdir -p clr-build
pushd clr-build
