...
Version  : 5.14.3
Release  : 7
URL      : https://download.kde.org/stable/plasma/5.14.3/kwrited-5.14.3.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.14.3/kwrited-5.14.3.tar.xz
Source99 : https://download.kde.org/stable/plasma/5.14.3/kwrited-5.14.3.tar.xz.sig
...
export LANG=C
export SOURCE_DATE_EPOCH=1541533149
mkdir -p clr-build
pushd clr-build
%cmake ..
