...
Source0  : https://download.kde.org/stable/plasma/5.17.5/kwrited-5.17.5.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.17.5/kwrited-5.17.5.tar.xz.sig
...
%prep
%setup -q -n kwrited-5.17.5
cd %{_builddir}/kwrited-5.17.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1578429167
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kwrited-5.17.5/COPYING %{buildroot}/usr/share/package-licenses/kwrited/7c203dee3a03037da436df03c4b25b659c073976
pushd clr-build
%make_install
popd
