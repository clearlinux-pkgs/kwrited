...
Version  : 5.23.4
Release  : 55
URL      : https://download.kde.org/stable/plasma/5.23.4/kwrited-5.23.4.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.23.4/kwrited-5.23.4.tar.xz
...
%prep
%setup -q -n kwrited-5.23.4
cd %{_builddir}/kwrited-5.23.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1638351774
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kwrited-5.23.4/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kwrited/3e8971c6c5f16674958913a94a36b1ea7a00ac46
pushd clr-build
%make_install
popd
