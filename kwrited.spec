...
Source0  : https://download.kde.org/stable/plasma/5.20.1/kwrited-5.20.1.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.20.1/kwrited-5.20.1.tar.xz.sig
...
%prep
%setup -q -n kwrited-5.20.1
cd %{_builddir}/kwrited-5.20.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1603214761
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kwrited-5.20.1/COPYING %{buildroot}/usr/share/package-licenses/kwrited/7c203dee3a03037da436df03c4b25b659c073976
pushd clr-build
%make_install
popd
