...
Version  : 6.4.0
Release  : 117
URL      : https://download.kde.org/stable/plasma/6.4.0/kwrited-6.4.0.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.4.0/kwrited-6.4.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.4.0/kwrited-6.4.0.tar.xz.sig
...
%setup -q -n kwrited-6.4.0
cd %{_builddir}/kwrited-6.4.0
pushd ..
cp -a kwrited-6.4.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1750178925
mkdir -p clr-build
pushd clr-build
