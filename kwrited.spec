...
Source0  : https://download.kde.org/stable/plasma/6.0.3/kwrited-6.0.3.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.0.3/kwrited-6.0.3.tar.xz.sig
...
%prep
%setup -q -n kwrited-6.0.3
cd %{_builddir}/kwrited-6.0.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711646365
mkdir -p clr-build
pushd clr-build
