...
Source0  : https://download.kde.org/stable/plasma/5.23.2/kwrited-5.23.2.tar.xz
...
%prep
%setup -q -n kwrited-5.23.2
cd %{_builddir}/kwrited-5.23.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1635352520
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kwrited-5.23.2/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kwrited/3e8971c6c5f16674958913a94a36b1ea7a00ac46
pushd clr-build
%make_install
popd
