...
Version  : 6.1.1
Release  : 100
URL      : https://download.kde.org/stable/plasma/6.1.1/kwrited-6.1.1.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.1.1/kwrited-6.1.1.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.1/kwrited-6.1.1.tar.xz.sig
...
%setup -q -n kwrited-6.1.1
cd %{_builddir}/kwrited-6.1.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719414486
mkdir -p clr-build
pushd clr-build
