...
Version  : 6.1.3
Release  : 102
URL      : https://download.kde.org/stable/plasma/6.1.3/kwrited-6.1.3.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.1.3/kwrited-6.1.3.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.3/kwrited-6.1.3.tar.xz.sig
...
%setup -q -n kwrited-6.1.3
cd %{_builddir}/kwrited-6.1.3
pushd ..
cp -a kwrited-6.1.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721141874
mkdir -p clr-build
pushd clr-build
